...
<body>
    ...
    <div class="button-container">
        <button class="action-button" onclick="createInvitation()">Выбрать автомобиль</button>
    ...
    <script>
        ...
        function loadCurrentRepairs() {
            ...
            xhr.open("GET", "get_current_repairs_cl.php?username=" + username, true);
    ...
    window.location.href = "insert_avto_cl.php?username=" + encodeURIComponent(username);
        }
    ...
    // Перенаправление на страницу создания ремонта с добавлением параметра в URL
    window.location.href = "confirm_order_cl.php?username=" + encodeURIComponent(username);
        }
    </script>
</body>
